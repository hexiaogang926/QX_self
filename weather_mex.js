 ...
 */
let config = {
    darksky_api: "2eefc8169c098695653578295f9f898b", //从https://darksky.net/dev/ 上申请key填入即可
    aqicn_api: "0e84c33b68cb1747afe62d72f55c1298941d2a92", //从http://aqicn.org/data-platform/token/#/ 上申请key填入即可
    huweather_apiKey: "54e5a794e9944299b914cd09162163f2", //和风天气APIkey,可自行前往 https://dev.heweather.com/ 进行获取
    lat_lon: "35.758191, 115.027813", //请填写经纬度,直接从谷歌地图中获取即可
...
$[hourly($[month]/$[day] $[hour]:00 气温 $[temperature]°C $[weatherIcon]$[weather])]`
        }
        }
    }
